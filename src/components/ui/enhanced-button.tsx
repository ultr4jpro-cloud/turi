  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "hero-gradient text-white shadow-warm hover:shadow-glow font-semibold tracking-wide border-0 transition-bounce hover:scale-105",
        mendoza: "bg-accent text-accent-foreground shadow-mountain hover:bg-accent/90 hover:shadow-glow",
        wine: "bg-secondary text-secondary-foreground shadow-warm hover:bg-secondary/90 hover:scale-105 transition-bounce",
      },
      size: {
